...
public class Postagem {
	...
	//Existem alguns outros também,como o AUTO (	Valor padrão, deixa com o provedor de persistência a escolha da estratégia mais adequada de acordo com o Banco de dados.)
	//Sequence (O provedor pode passar uma sequencia de como ele gostaria que fossem criada a sequência das chaves primárias)
	...
	@UpdateTimestamp
	//Timestamp, ou seja, o Spring se encarregará de obter a data e a hora do Sistema Operacional e inserir no
	//Atributo data toda vez que um Objeto da Classe Postagem for criado ou atualizado.
